        ...
        <Card sx={{ mt: 5 }} style={{ backgroundColor: '#1e272e', padding: '1rem'}} >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TextField
              ...
              helperText={isNaN(factura.LecturaActual) ? 'Solo se permiten números' : ''}
              error={isNaN(factura.LecturaActual)}
            />
            ...
            <TextField
              ...
              helperText={isNaN(factura.LecturaAntigua) ? 'Solo se permiten números' : ''}
              error={isNaN(factura.LecturaAntigua)}
            />

            <TextField
              variant="outlined"
              label="Consumo"
               sx={{ display: 'block', margin: '.5rem 0', width: '200px', textAlign: 'right' }}
              name="Consumo"
            ...
            <TextField
              variant="outlined"
              label="Total"
              sx={{ display: 'block', margin: '.5rem 0', width: '200px', textAlign: 'right', marginBottom: '1rem' }}
              name="Total"
              value={factura.Total}
              onChange={handleChange}
              inputProps={{ readOnly: true, style: { color: 'white' } }}
